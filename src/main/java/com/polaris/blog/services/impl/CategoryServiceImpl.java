...
public class CategoryServiceImpl extends BaseService implements CategoryService {
    ...
    public ResponseResult updateCategory(Category category, String categoryId) {
        ...
        if (!TextUtil.isEmpty(category.getPinyin())) categoryFromDB.setName(category.getPinyin());
        if (!TextUtil.isEmpty(category.getDescription())) categoryFromDB.setName(category.getDescription());
